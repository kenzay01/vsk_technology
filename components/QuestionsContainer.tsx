...
export default function QuestionsContainer() {
  ...
  return (
    <section className="w-full py-4 sm:py-6 md:py-8 px-4 sm:px-6 md:px-16 bg-white flex flex-col sm:flex-col md:flex-row gap-6 sm:gap-6 md:gap-8">
      <div className="flex-1 flex flex-col gap-3 sm:gap-4 justify-start items-center mt-4">
        <h1 className="text-3xl sm:text-3xl md:text-4xl font-serif text-center">
          Frequently Asked Questions
        </h1>
        <h2 className="text-sm sm:text-base md:text-md text-center">
